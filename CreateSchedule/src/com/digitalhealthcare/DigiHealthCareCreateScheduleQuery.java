...
public class DigiHealthCareCreateScheduleQuery {
	...
	public static String SQL_GETSTAFFEMAIL = " select Fname,Lname, Emailid, Phone1 from Staff_table where Staff_id= ? "; 
	...
	public static String SQL_MESSAGETEXT = "insert into Messages_table(Message_id,Apt_id,Patient_id,User_id,phoneNumber,emailId,Message_text,Create_date,Message_type,Message_category)"+"values(?,?,?,?,?,?,?,?,?,?)"; 
